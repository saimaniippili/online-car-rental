            ...
            <div style={{ background: '#050505', minHeight: '100vh', paddingTop: '100px', paddingBottom: '50px' }}>
               <Row justify='center mt-5'>
                   <Col lg={12} sm={24} xs={24} className='p-2'>
                       <Form className='luxury-card p-4' layout='vertical' onFinish={onFinish} style={{ background: 'rgba(15, 15, 15, 0.7)', border: '1px solid #333' }}>
                           <h1 style={{ color: 'white', fontWeight: 300, letterSpacing: '2px', textAlign: 'center', marginBottom: '30px' }}>ADD NEW VEHICLE</h1>
                           <hr style={{ borderColor: '#333', marginBottom: '30px' }} />
                           <Form.Item name='name' label={<span style={{ color: '#ccc' }}>Vehicle Name</span>} rules={[{required: true}]}>
                           ...
                           <Form.Item name='rentPerHour' label={<span style={{ color: '#ccc' }}>Rent Per Hour (₹)</span>} rules={[{required: true}]}>
                               <Input type="number" style={{ background: '#111', border: '1px solid #333', color: 'white', padding: '10px' }} />
                           </Form.Item>
                           <Form.Item name='capacity' label={<span style={{ color: '#ccc' }}>Seating Capacity</span>} rules={[{required: true}]}>
                               <Input type="number" style={{ background: '#111', border: '1px solid #333', color: 'white', padding: '10px' }} />
                           </Form.Item>
                           <Form.Item name='fuelType' label={<span style={{ color: '#ccc' }}>Drivetrain / Fuel Type</span>} rules={[{required: true}]}>
                               <Input style={{ background: '#111', border: '1px solid #333', color: 'white', padding: '10px' }} />
                           </Form.Item>

                           <div className='text-right mt-5'>
                           <button className='premium-btn' style={{ width: '100%', padding: '15px' }}>ADD VEHICLE</button>
                           </div>
